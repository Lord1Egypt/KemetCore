...
**Scope (current):** Phase 0/1 covers fp16/bf16/fp32 add, mul, fma, cmp, classify with correct bf16 round-to-nearest-even. div/sqrt and fp64 land with RTL (Phase 2).

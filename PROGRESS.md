...
_Auto-generated by `tools/gen_tracking.py` on 2026-06-27. Single source of truth: `tools/manifest.py`._
...
## Overall: 33%  `█████████░░░░░░░░░░░░░░░░░░░░░`  (22/66 phase-slots done)
...
| 06 | **AnubisCore** | SHA-256 / SHA-3 hash engine | ✅ | ✅ | 🔧 | ⬜ | ⬜ | ⬜ | 33% | [steps](projects/anubiscore/STEPS.md) · [chk](projects/anubiscore/CHECKPOINTS.md) · [tests](projects/anubiscore/TESTS.md) |
...
Every project's **Phase 0 (golden reference)** and **Phase 1 (pymodel)** are implemented in pure Python and covered by passing pytest. These are RAM-trivial (<0.5 GB) and run on any laptop. **Phases 2–5 (RTL → GDSII)** are the RAM-heavy part and are not started — see RAM budget below.

# SobekCore — Build STEPS

> Deity: Sobek (Nile) · Domain: Ray-triangle intersector · Spec: [docs/08_SobekCore_RayTrace.md](../../docs/08_SobekCore_RayTrace.md)

_Auto-generated from `tools/manifest.py` — do not edit by hand; edit the manifest and run `python tools/gen_tracking.py`._

**Scope (current):** Phase 0/1 implements watertight Moller-Trumbore ray-triangle intersection golden and a pipelined pymodel. Phase 4: sobek_dot3, sobek_lerp, sobek_ray_point, sobek_faceforward, sobek_cross, sobek_scale, and sobek_distance signed off on ASAP7 7nm (registered boundary).
...
pytest projects/sobekcore/tests -v
# 2. read its checkpoints + tests
cat projects/sobekcore/CHECKPOINTS.md projects/sobekcore/TESTS.md

...
PROJECTS = [
    ...
    },
    {
        ...
        "scope": "Phase 0/1 implements an RVV-subset golden (vsetvl, vadd/vsub/vmul/vmacc, "
                 ...
                 "Phase 4: atum_valu, atum_vredu, atum_vsadd, atum_vcompress, atum_viota, atum_vmask, atum_vsetvl, atum_vfpu, and atum_vregfile signed off on ASAP7 7nm (registered boundaries).",
        "checkpoints": [

...
echo "=== synthesizing hapi_fp16_class ==="
"$YOSYS" -ql "reports/hapi_fp16_class.log" -p "
    read_verilog -sv ../rtl/hapi_fp16_class.sv;
    synth -top hapi_fp16_class;
    select -assert-none t:\$_DLATCH_* t:\$dlatch;
    tee -o reports/hapi_fp16_class.stat stat
"
echo "  -> reports/hapi_fp16_class.stat (0 latches asserted)"
echo "=== synthesizing hapi_fp16_sgnj ==="
"$YOSYS" -ql "reports/hapi_fp16_sgnj.log" -p "
    read_verilog -sv ../rtl/hapi_fp16_sgnj.sv;
    synth -top hapi_fp16_sgnj;
    select -assert-none t:\$_DLATCH_* t:\$dlatch;
    tee -o reports/hapi_fp16_sgnj.stat stat
"
echo "  -> reports/hapi_fp16_sgnj.stat (0 latches asserted)"
echo "=== synthesizing hapi_bf16_minmax ==="
"$YOSYS" -ql "reports/hapi_bf16_minmax.log" -p "
    read_verilog -sv ../rtl/hapi_bf16_minmax.sv;
    synth -top hapi_bf16_minmax;
    select -assert-none t:\$_DLATCH_* t:\$dlatch;
    tee -o reports/hapi_bf16_minmax.stat stat
"
echo "  -> reports/hapi_bf16_minmax.stat (0 latches asserted)"
echo "=== synthesizing hapi_bf16_cmp ==="
"$YOSYS" -ql "reports/hapi_bf16_cmp.log" -p "
    read_verilog -sv ../rtl/hapi_bf16_cmp.sv;
    synth -top hapi_bf16_cmp;
    select -assert-none t:\$_DLATCH_* t:\$dlatch;
    tee -o reports/hapi_bf16_cmp.stat stat
"
echo "  -> reports/hapi_bf16_cmp.stat (0 latches asserted)"
echo "=== synthesizing hapi_bf16_class ==="
"$YOSYS" -ql "reports/hapi_bf16_class.log" -p "
    read_verilog -sv ../rtl/hapi_bf16_class.sv;
    synth -top hapi_bf16_class;
    select -assert-none t:\$_DLATCH_* t:\$dlatch;

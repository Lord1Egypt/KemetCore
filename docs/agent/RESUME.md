...
- Hardened `seth_aluctl` to ASAP7 7nm via ORFS. WNS 0.00, area 14 um^2.
- Tracking and WORKLOG updated for all.

# Next Step
- Open a PR for `seth_aluctl`. Wait for PR #246 and PR #247 CI to pass and merge them. Proceed to the next core in Phase 3/4 based on `PROGRESS.md`.

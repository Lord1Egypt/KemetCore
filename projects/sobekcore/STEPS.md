...
**Scope (current):** Phase 0/1 implements watertight Moller-Trumbore ray-triangle intersection golden and a pipelined pymodel. Phase 4: sobek_dot3, sobek_lerp, sobek_ray_point, sobek_faceforward, sobek_cross, and sobek_scale signed off on ASAP7 7nm (registered boundary).

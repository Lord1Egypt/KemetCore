...
PROJECTS = [
    ...
    },
    {
        ...
        "scope": "Phase 0/1: negacyclic NTT over Z_q (q=7681, NTT-friendly) plus a "
                 ...
                 "params (q=3329). Phase 4: neith_ntt and neith_polyaddsub signed off on ASAP7 7nm. NOTE: reference model, not "
                 "FIPS-203 certified.",
        "checkpoints": [
    ...
    },
    {
        ...
        "scope": "Phase 0/1 implements watertight Moller-Trumbore ray-triangle intersection "
                 "golden and a pipelined pymodel. Phase 4: sobek_dot3, sobek_cross, and sobek_scale "
    ...
    },
    {
        ...
        "scope": "Phase 0/1 implements an RVV-subset golden (vsetvl, vadd/vsub/vmul/vmacc, "
                 ...
                 "Phase 4: atum_valu, atum_vredu, atum_vsadd, and atum_vcompress signed off on ASAP7 7nm (registered boundaries).",
        "checkpoints": [

...
LABEL = {
    ...
    "sha3_256_core": ("AnubisCore",  "SHA3-256/Keccak core"),
    ...
    "seth_aluctl":   ("SethCore",    "RV32I ALU control decoder (registered)"),
...
ORDER = ["ra_noc_arbiter","ra_kai_regs","seth_regfile","seth_alu","seth_muldiv","seth_branch","seth_imm","seth_aluctl","seth_decode","seth_trap","seth_lsu",
         ...
         "geb_spmac","geb_spmac_grid","bast_mac","bast_mac_grid","bast_int8_mac","sha256_core","sha3_256_core",

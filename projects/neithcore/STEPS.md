...
**Scope (current):** Phase 0/1 implements the NTT over Z_3329 (the core datapath) plus a Kyber-512-style module-LWE KEM that is self-consistent (decaps recovers the encaps shared secret). NOTE: reference model, not FIPS-203 certified.

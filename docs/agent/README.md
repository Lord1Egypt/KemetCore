...
| [`GOAL_MODE.md`](GOAL_MODE.md) | **`/goal` autonomous mode** — the work→verify→self-review→self-merge→repeat loop + hard safety rails. Entered via the `/goal` command (`.gemini/commands/goal.toml`). |

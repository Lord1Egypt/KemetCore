...
- Hardened `seth_decode` to ASAP7 7nm via ORFS. WNS 0.00, area 16 um^2.
- Tracking and WORKLOG updated for all.

# Next Step
- Open a PR for `seth_decode`. Wait for PRs CI to pass and merge them. Proceed to the next core in Phase 3/4 based on `PROGRESS.md`.

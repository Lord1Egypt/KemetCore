"""cocotb testbench for AnubisCore shake256_xof_core — bit-exact vs hashlib.shake_256.
...
async def test_vectors(dut):
    ...
    dut._log.info(f"shake256_xof_core verified bit-exact vs hashlib on {len(cases)} cases")

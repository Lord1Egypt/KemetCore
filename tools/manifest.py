...
PROJECTS = [
    {
        ...
        "scope": "Phase 0/1: fp16/bf16/fp32 add, mul, fma, cmp, classify with correct "
                 ...
                 "hapi_fp16_mul, hapi_bf16_mul, hapi_fp16_add, hapi_bf16_add, hapi_fp32_add, hapi_fp32_to_int, hapi_int_to_fp32, hapi_fp32_to_bf16, hapi_fp32_to_fp16, hapi_bf16_to_fp32, and hapi_fp16_to_fp32 signed off on ASAP7 7nm (registered boundary, WNS 0.00).",
        "checkpoints": [
